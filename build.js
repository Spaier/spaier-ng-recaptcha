...
if (shell.exec(`ngc -p tsconfig.app.json`).code !== 0) {
...
shell.exec(`ngc -p tsconfig.app.json --target es5 -d false --outDir ${OUT_DIR_ESM5} --importHelpers true --sourceMap`);
...
shell.cp(`-Rf`, [`package.json`, `LICENSE`, `README.md`, `typings`], `${NPM_DIR}`);
